...
if "counter" not in st.session_state: st.session_state.counter = 0 # Total
...
if st.sidebar.button("🔄 Zerar Contador"):
    st.session_state.counter = 0
    st.session_state.counter_correct = 0
    st.session_state.counter_incorrect = 0
            ...
            if result.pose_landmarks:
                ...
                if exercise_type == "Agachamento Búlgaro":
                    ...
                    if knee_angle > user_thresholds['knee_max']:
                        ...
                        st.session_state.stage = "down" # Marca que desceu
                ...
                if current_state == CONSTANTS['stages']['UP'] and st.session_state.stage == "down":
                    ...
                    if st.session_state.has_error:
                        st.session_state.counter_incorrect += 1
                    else:
                        st.session_state.counter_correct += 1
                ...
                if alert_msg: 
                    cv2.putText(frame, f"ALERTA: {alert_msg}", (10, 85), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
